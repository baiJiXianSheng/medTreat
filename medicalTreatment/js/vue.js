...
(function(global, factory) {
	global.Vue = factory();//force to create global Vue instead of module
	return;
	...
	setTimeout(function() {
		if(config.devtools) {
			...
			} else if(Vue.config.debug && 'development' !== 'production' && inBrowser && /Chrome\/\d+/.test(window.navigator.userAgent)) {
